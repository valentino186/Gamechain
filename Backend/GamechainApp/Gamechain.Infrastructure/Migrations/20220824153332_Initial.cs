    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameCart", x => new { x.GameId, x.CartId });
                    table.ForeignKey(
                        name: "FK_GameCart_Carts_CartId",
                        column: x => x.CartId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameFeature", x => new { x.GameId, x.FeatureId });
                    table.ForeignKey(
                        name: "FK_GameFeature_Features_FeatureId",
                        column: x => x.FeatureId,
                        principalTable: "Features",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameFeature_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameWishlist_Wishlists_WishlistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameCart_CartId",
                table: "GameCart",
                column: "CartId");

            migrationBuilder.CreateIndex(
                name: "IX_GameFeature_FeatureId",
                table: "GameFeature",
                column: "FeatureId");
